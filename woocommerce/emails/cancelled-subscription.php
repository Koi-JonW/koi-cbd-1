...
<p><?php printf( esc_html__( 'The user %1$s requests that the subscription detailed below be unsubscribed:', 'woocommerce-subscriptions' ), esc_html( $subscription->get_formatted_billing_full_name() ) );?></p>
...
<br/>
<strong>To confirm the cancellation of this subscription, please click the following link and change the subscription status from Pending Cancellation to Cancelled.</strong><br/>
<a href="<?php echo esc_url( wcs_get_edit_post_link( $subscription->get_id() ) ); ?>">Cancel subscription #<?php echo esc_html( $subscription->get_order_number() ); ?></a>
<br/>
<div style="width:100%; text-align:center;">
<img src="https://koicbd.com/wp-content/uploads/cancelled-subscription.jpg" alt="cancelled" style="max-width:360px; width:100%;"/>
</div>
<?php
